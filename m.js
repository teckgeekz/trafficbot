...
const venenoTrafficBot = async id => {
	...
	if(osFamily == 'Android'){
		screenArray = [[1440,2560],[1080,1920],[1440,3120],[1440,869],[1080,2280],[1080,2160],[1080,2220],[1440,2960],[1080,2160],[1440,2560],[1440,2560],[1080,1920],[240,320],[320,480],[480,800], [600,1024], [720,1280], [800,1280]];
	} else if (osFamily == 'IOS'){
		screenArray = [[1170,2532],[828,1792],[1125,2436],[1242,2688],[1125,2436],[1080,1920],[750,1334],[1080,1920],[750,1334],[1080,1920],[750,1334],[640,1136]];
	} else {
		screenArray = [[1920x1080],[1366x768],[1280x1024],[1280x800],[1024x768],[640,480],[800,600], [1024,768], [1152,864], [1280,1024], [1366,768],[1600,1200]];
	}
